...
SET "SOURCE1=\\10.3.92.10\DATA-PG8\Quellsammlung"
SET "SOURCE2=\\10.1.91.11\DATA-PG8\Quellsammlung"
SET "SOURCE3=\\10.3.91.11\DATA-PG8\Quellsammlung"
SET "DEST=C:\Quellsammlung"
...
SET "LOGFILE=C:\_POST_LOGS\robocopy_sync_source_image_%STAMP%.log"
...
if %RC% GEQ 8 (
  ...
  echo Source Image Sync completed successfully
  exit /b 0
)
