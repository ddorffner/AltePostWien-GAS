...
SET "SOURCE1=\\10.3.92.10\DATA-PG8\KI\SYNC\models"
SET "SOURCE2=\\10.1.91.11\DATA-PG8\KI\SYNC\models"
SET "SOURCE3=\\10.3.91.11\DATA-PG8\KI\SYNC\models"
SET "DEST=D:\ComfyUI\models"
...
SET "LOGFILE=D:\_POST_LOGS\robocopy_sync_comfy_models_%STAMP%.log"
...
if %RC% GEQ 8 (
  ...
  echo Comfy Models sync completed successfully
  exit /b 0
)
