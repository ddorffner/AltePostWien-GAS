...
SET "SOURCE1=\\10.3.92.10\DATA-PG8\KI\SYNC\custom_nodes"
SET "SOURCE2=\\10.1.91.11\DATA-PG8\KI\SYNC\custom_nodes"
SET "SOURCE3=\\10.3.91.11\DATA-PG8\KI\SYNC\custom_nodes"
SET "DEST=D:\ComfyUI\custom_nodes"
...
SET "LOGFILE=D:\_POST_LOGS\robocopy_sync_comfy_custom_nodes_%STAMP%.log"
