...
SET "SOURCE1=\\10.3.92.10\DATA-PG8\ComfyUI\models"
SET "SOURCE2=\\10.1.91.11\DATA-PG8\ComfyUI\models"
SET "SOURCE3=\\10.3.91.11\DATA-PG8\ComfyUI\models"
SET "DEST=C:\ComfyUI\models"
...
SET "LOGFILE=C:\_POST_LOGS\robocopy_sync_comfy_models_%STAMP%.log"
