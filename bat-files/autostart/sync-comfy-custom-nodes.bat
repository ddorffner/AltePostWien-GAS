...
SET "SOURCE1=\\10.3.92.10\DATA-PG8\ComfyUI\custom_nodes"
SET "SOURCE2=\\10.1.91.11\DATA-PG8\ComfyUI\custom_nodes"
SET "SOURCE3=\\10.3.91.11\DATA-PG8\ComfyUI\custom_nodes"
SET "DEST=C:\ComfyUI\custom_nodes"
...
SET "LOGFILE=C:\_POST_LOGS\robocopy_sync_comfy_custom_nodes_%STAMP%.log"
...
if %RC% GEQ 8 (
  ...
  echo Comfy Custom Nodes sync completed successfully
  exit /b 0
)
