...
SET "SOURCE1=\\10.3.92.10\DATA-PG8\Asset\Image"
SET "SOURCE2=\\10.1.91.11\DATA-PG8\Asset\Image"
SET "SOURCE3=\\10.3.91.11\DATA-PG8\Asset\Image"
SET "DEST=C:\Asset\Image"
...
SET "LOGFILE=C:\_POST_LOGS\robocopy_sync_asset_image_%STAMP%.log"
