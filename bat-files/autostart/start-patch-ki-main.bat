@echo off
set VVVV_PATH=C:\Program Files\vvvv\vvvv_gamma_7.1-0013-g8fcece0df9-win-x64\vvvv.exe
set PATCH_PATH=C:\Users\SHA.ART\Documents\AltePost\AltePostWien\KI\KI_MAIN_GUI.vl
