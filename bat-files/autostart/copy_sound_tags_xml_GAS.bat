...
set "SOURCE_PATH=C:\Asset-GAS-02\Sound\material"
set "DEST_PATH=\\10.3.91.11\data-pg8\Asset-GAS-02\Sound\material"

:: Display the paths being used
echo.
echo Copying XML files ending with "__Tags.xml"...
...
robocopy "%SOURCE_PATH%" "%DEST_PATH%" *__Tags.xml /S /NDL /NP /R:3 /W:1
